...
#         "final_norm_scale": "layer_norm weight", ##for mbart
#         "final_norm_bias": "layer_norm bias",
#     }
# )
#
...
#         "norm_scale": "layernorm_embedding weight",
#         "norm_bias": "layernorm_embedding bias",
#         "final_norm_scale": "layer_norm weight",
#         "final_norm_bias": "layer_norm bias",
...
src_emb_mapping_dict = OrderedDict(
    {
        ...
        "final_norm_scale": "layernorm_embedding weight", ##for mbart
        "final_norm_bias": "layernorm_embedding bias",
    }
)
...
trg_emb_mapping_dict = OrderedDict(
    {
        "norm_scale": "layer_norm weight",
        "norm_bias": "layer_norm bias",
        "final_norm_scale": "layernorm_embedding weight",
        "final_norm_bias": "layernorm_embedding bias",
        "shared_bias": "final_logits_bias",
    }
)
...
def save_bart_proto_to_hdf5(transformer: Transformer, f: h5py.File):
    ...
    EMBEDDING_KEYS = [
        ...
        "shared_bias",
        "lang_emb",
        "final_norm_scale", ## for mbart
        "final_norm_bias",  ## for mbart
        "trg_vocab_mask",
    ]
...
def extract_transformer_weights(
    ...
    # load var names
    reloaded = MBartForConditionalGeneration.from_pretrained(model_dir).state_dict()
...
if __name__ == "__main__":
    ...
    output_lightseq_model_name = "lightseq_mbart_base"  # you can rename it to "lightseq_bart_large" for large model
    input_huggingface_bart_model = (
        "facebook/mbart-large-cc25"  # Example: you can try "facebook/bart-large" as well
    )
